           ...
           <label for="exampleFormControlInput1" class="form-label">Nom complet</label>
            ...
            <div class="mb-3  fw-bold">
                <label for="exampleFormControlInput1" class="form-label">Email</label>
                    <input type="email" data-parsley-type="email" class="form-control" id="emailadminupd" name="emailadminupd"required data-parsley-trigger="change">
             </div>
             <div class="mb-3  fw-bold">
                <label for="exampleFormControlInput1" class="form-label">Password</label>
                    <input type="password" class="form-control" id="passwordadminupd" name="passwordadminupd" required data-parsley-trigger="change">
             </div>
             <input type="button"  class="btn btn-outline-warning btn-lg  " style="background-color:#ab64a26a; color:#410839" name="Addadmin" value="Modifier Admin">
