...
<div class="container-fluid"style="padding-left: 0px;margin-left: 159px;margin-top: 0px; margin-right:0px;" >
            <div class="  mx-3 mt-3 table-wrapper" style="height:100vh">
                    <div class="table-title">
                        <div class="">
                            <div class="col">
                            <button type="button" class="btn btn-outline btn-lg fw-bold mb-3 fd" style="background-color:#a80893c3; margin-left: 67px; margin-top: 75px;  " data-bs-toggle="modal" data-bs-target="#exampleModal">command Anastasia<img src="https://img.icons8.com/doodle/64/undefined/used-product.png" > </button>
