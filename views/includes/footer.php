<footer class="py-5 " style=" background: #ab64a2;">
        <div class="container"><p class="m-0 text-center  fw-bold " style="color:rgb(59 57 57);">Copyright &copy;Anastasiafashion 2022</p></div>
